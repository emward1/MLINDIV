...
% filenames = dir("/mnt/chrastil/lab/users/erica/projects/MLINDIV/Arrays/sub-033_Ex*Coh_2mm_3Darray.mat");
formatspec = "/mnt/chrastil/lab/users/erica/projects/MLINDIV/Arrays/S200/sub-%03d_Ex_HOsubcort+Schaefer200_2mm_3Darray.mat";
arrayname = sprintf(formatspec, subject_id);
filenames = dir(arrayname);
...
formatspec = "/mnt/chrastil/lab/users/erica/projects/MLINDIV/Arrays/S200/sub-%03d_Run_HOsubcort+Schaefer200_2mm_3Darray.mat";
arrayname = sprintf(formatspec, subject_id);
filenames = dir(arrayname);
...
% Save to file
formatspec = "partitions/S200/sub%03d_consensus.mat";
filename = sprintf(formatspec, subject_id);
