...
#SBATCH -c 4
#SBATCH -o /mnt/chrastil/lab/users/erica/projects/MLINDIV/slurmlog/rundccc-%j.out
...
/tmp/mribin/matlab/R2019b/bin/matlab -nojvm -r "cd('$analysis_dir');run_DCcommunityconsensus_ExpOnly($sub,$gam,$ome,$n_partitions);exit";
